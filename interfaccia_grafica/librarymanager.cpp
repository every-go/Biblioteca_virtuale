...
Riviste* LibraryManager::createRiviste(){
    ...
    if (diffusione == "Provinciale")
        ...
        diff = Riviste::Internazionale;
    return new Riviste(biblio.titolo.toStdString(), biblio.genere.toStdString(), biblio.anno, biblio.costo,
...
Cd* LibraryManager::createCd(){
    ...
    return new Cd(biblio.titolo.toStdString(), biblio.genere.toStdString(), biblio.anno, biblio.costo,
                  biblio.disponibile, biblio.copie, biblio.nprestiti, image.toStdString(),
...
Film* LibraryManager::createFilm(){
    ...
    return new Film(biblio.titolo.toStdString(), biblio.genere.toStdString(), biblio.anno, biblio.costo,
                    biblio.disponibile, biblio.copie, biblio.nprestiti, image.toStdString(),
